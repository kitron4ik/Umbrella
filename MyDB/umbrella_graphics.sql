...
CREATE TABLE `graphics` (
  `idgraphics` int NOT NULL AUTO_INCREMENT,
  `doctors_iddoctors` int NOT NULL,
  `hoidays_begin` date DEFAULT NULL,
  `holidays_end` date DEFAULT NULL,
  `workingdays` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idgraphics`),
  KEY `fk_graphics_doctors1_idx` (`doctors_iddoctors`),
  CONSTRAINT `fk_graphics_doctors1` FOREIGN KEY (`doctors_iddoctors`) REFERENCES `doctors` (`iddoctors`) ON DELETE CASCADE ON UPDATE CASCADE
